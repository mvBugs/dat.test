                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-1.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-1.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-2.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-2.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-3.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-3.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-4.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-4.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-5.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-5.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-6.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-6.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="wood-img__block">
                                <a href="/its-client/img/wood-img-7.png" data-fancybox="gallery">
                                    <img src="/its-client/img/wood-img-7.png" alt="">
                                    <div class="hide">
                                        <svg class="icon-svg icon-svg-add "><use xlink:href="/its-client/img/sprite.svg#add"></use></svg>
                                    </div>
                                </a>
