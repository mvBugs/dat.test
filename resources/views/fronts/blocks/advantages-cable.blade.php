<div class="about about_advantages">
    <div class="about__wrapper">
        ...
        {!! \BlockVisualEditor::render('advantages-cable', '
            <div class="advantages__wrapper">
                <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="1">
                    <div class="advantages__img">
                        <svg class="icon-svg icon-svg-advantages-1 "><use xlink:href="./img/sprite.svg#advantages-1"></use></svg>
                    </div>
                ...
                <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="1.6">
                    <div class="advantages__img">
                        <svg class="icon-svg icon-svg-advantages-2 "><use xlink:href="./img/sprite.svg#advantages-2"></use></svg>
                    </div>
                ...
                <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="2.2">
                    <div class="advantages__img">
                        <svg class="icon-svg icon-svg-advantages-3 "><use xlink:href="./img/sprite.svg#advantages-3"></use></svg>
                    </div>
                ...
                <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="2.8">
                    <div class="advantages__img">
                        <svg class="icon-svg icon-svg-advantages-7 "><use xlink:href="./img/sprite.svg#advantages-7"></use></svg>
                    </div>
                ...
                <div class="block-bottom">
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="3.6">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-advantages-5 "><use xlink:href="./img/sprite.svg#advantages-5"></use></svg>
                        </div>
                    ...
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="4.2">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-advantages-6 "><use xlink:href="./img/sprite.svg#advantages-6"></use></svg>
                        </div>
                    ...
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="5">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-wood-5 "><use xlink:href="./img/sprite.svg#wood-5"></use></svg>
                        </div>
                        <div class="advantages__name">Широкая география поставок</div>
                        <div class="advantages__text">Россия, СНГ, ближнее зарубежье</div>
                    </div>

                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="5.6">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-advantages-4 "><use xlink:href="./img/sprite.svg#advantages-4"></use></svg>
                        </div>
                ...
                <div class="block-bottom block-bottom_inner">
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="6.2">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-wood-3 "><use xlink:href="./img/sprite.svg#wood-3"></use></svg>
                        </div>
                        <div class="advantages__name">3-4 дня</div>
                        <div class="advantages__text">Среднее время производства фуры</div>
                    </div>
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="6.8">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-wood-2 "><use xlink:href="./img/sprite.svg#wood-2"></use></svg>
                        </div>
                        <div class="advantages__name">2012 г</div>
                        <div class="advantages__text">Год основания компании</div>
                    </div>
                    <div class="advantages__block my-animate fadeInUp" data-duration="2" data-delay="7.4">
                        <div class="advantages__img">
                            <svg class="icon-svg icon-svg-wood-1 "><use xlink:href="./img/sprite.svg#wood-1"></use></svg>
                        </div>
                        <div class="advantages__name">Производственных цеха</div>
                    </div>
                </div>
            </div>
            ') !!}
